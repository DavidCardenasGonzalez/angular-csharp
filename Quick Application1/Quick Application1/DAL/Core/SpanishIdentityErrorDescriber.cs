...
public class SpanishIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"Ya existe una cuenta asociada a {userName}. Puedes recupar su contraseña desde la pantalla de inicio."  }; }
    public override IdentityError DuplicateEmail(string email) { return new IdentityError { Code = nameof(DuplicateEmail), Description = $"La direccion de email {email} ya se encuentra registrada. Puedes recupar su contraseña desde la pantalla de inicio."  }; }
